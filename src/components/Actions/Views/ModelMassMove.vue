    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="Card_Field">
          ...
          <work-group v-else-if="model == 'group'" :name="action.computed.work_group_name" :link="false" />
        </div>
      </div>
      <div class="col-sm-6">
