<template>
  <div class="Card">
    <div class="CardHeader">
      <h3>Action: discover {{ modelName }}</h3>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="Card_Field">
          ...
          <work-group
            v-if="model == 'work_group'"
            :name="action.computed.work_group_name"
            :link="false"
          />
          <group v-else-if="model == 'group'" :name="action.computed.group_name" :link="false"/>
          <datacenter
            v-else-if="model == 'datacenter'"
            :name="action.computed.datacenter_name"
            :link="false"
          />
